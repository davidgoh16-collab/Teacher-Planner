    ...
    <>
      ...
      >
          {activeTab === 'home' ? (
            ...
            <TimetableView
              needsSetup={!isPlannerDataLoading && (academicYears.length === 0 || terms.length === 0)}
              isDataLoading={isDataLoading}
              onStartSetup={() => setShowOnboarding(true)}
              onOpenSettings={() => setIsSettingsOpen(true)}
              currentWeekData={currentWeekData}
              timetableWeek1={timetableWeek1}
              timetableWeek2={timetableWeek2}
              lessonPlans={lessonPlans}
              globalTasks={globalTasks}
              projects={projects}
              routineTasks={routineTasks}
              ...
              onJumpToCurrentWeek={handleJumpToCurrent}
            />
          ) : activeTab === 'meetings' ? (
